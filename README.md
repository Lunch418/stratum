...
подменяется в работающей модели без сброса), редактор кода (Monaco, грамматика
...
текстуры, `CreateObjectFromFile3d` (v3d), `SweepAndExtrude3d`, Ogre3D. Из
этапа 4: граф зависимостей переменных, свойства графических объектов. Из этапа 2 остались настоящие
