...
(Ctrl+Shift+P), графики наблюдаемых переменных (∿ в инспекторе), редактор кода (Monaco, грамматика
...
Из этапа 2 остался звук (сейчас заглушки); 3D — этап 5. Этап 4: отладка
(точки останова, шаг назад, наблюдение выражений). Из этапа 2 остались настоящие
