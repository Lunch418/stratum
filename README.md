...
удаление Delete, Undo/Redo Ctrl+Z / Ctrl+Shift+Z), редактор кода (Monaco, грамматика
...
Этап 3 продолжается: командная палитра, переименование и удаление имиджей,
графики наблюдаемых переменных, раскладка панелей, установщики Tauri. Из этапа 2 остались настоящие
