...
пауза при ошибке с подсветкой строки, профиль такта), редактор кода (Monaco, грамматика
...
Из этапа 2 остался звук (сейчас заглушки); 3D — этап 5. Из этапа 4: граф
зависимостей переменных, справка F1, автосохранение, фильтр сообщений. Из этапа 2 остались настоящие
