...
(Alt+щелчок в окне модели: положение, линия, заливка, точки), редактор кода (Monaco, грамматика
...
этапа 4: граф зависимостей переменных. Из этапа 2 остались настоящие
