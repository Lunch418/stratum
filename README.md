...
автосохранение проектов в родном формате, редактор кода (Monaco, грамматика
...
зависимостей переменных, свойства графических объектов в инспекторе. Из этапа 2 остались настоящие
